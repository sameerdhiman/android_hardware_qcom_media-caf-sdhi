...
libmm-vdec-inc          += hardware/qcom/media-caf-sdhi/mm-core/inc
#DRM include - Interface which loads the DRM library
libmm-vdec-inc	        += $(OMX_VIDEO_PATH)/DivxDrmDecrypt/inc
libmm-vdec-inc          += hardware/qcom/display-caf-sdhi/libgralloc
libmm-vdec-inc          += frameworks/native/include/media/openmax
libmm-vdec-inc          += frameworks/native/include/media/hardware
libmm-vdec-inc          += $(vdec-inc)
libmm-vdec-inc          += hardware/qcom/display-caf-sdhi/libqdutils
libmm-vdec-inc      += hardware/qcom/media-caf-sdhi/libc2dcolorconvert
libmm-vdec-inc      += hardware/qcom/display-caf-sdhi/libcopybit
libmm-vdec-inc      += frameworks/av/include/media/stagefright
libmm-vdec-inc      += $(TARGET_OUT_HEADERS)/mm-video/SwVdec
libmm-vdec-inc      += $(TARGET_OUT_HEADERS)/qcom/display-caf-sdhi/

ifneq ($(call is-platform-sdk-version-at-least, 19),true)
libOmxVdec-def += -DMETADATA_FOR_DYNAMIC_MODE
libmm-vdec-inc += hardware/qcom/media-caf-sdhi/libstagefrighthw
endif
...
libmm-vdec-inc          += hardware/qcom/display-caf-sdhi/libhwcomposer
...
mm-vdec-test-inc    := hardware/qcom/media-caf-sdhi/mm-core/inc
...
mm-vdec-drv-test-inc    := hardware/qcom/media-caf-sdhi/mm-core/inc
